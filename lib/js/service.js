...
function prepareClient(config) {
    ...
    return new Promise(async function(resolve,reject) {
        ...
        resolve({
            natives: source.natives.replace(new RegExp(" ","g"),"\\ "),
            classPath: classPath.join(':').replace(new RegExp(" ","g"),"\\ "),
            mainClass: versionJSON.mainClass,
            version: config.version,
            gameDir: config.root.replace(new RegExp(" ","g"),"\\ "),
            assetsDir: source.assets.replace(new RegExp(" ","g"),"\\ "),
